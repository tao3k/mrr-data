...
=MRR_LOCAL_MAX_BYTES= (default 1 GiB) bounds protection admission against
physical CID files. Remote query fills can increase disk use beyond this
admission bound; deployments must provision the local filesystem accordingly.
