* Snapshot distribution audit — 2026-09-20
...
[[file:../../evidence/s3-conformance-receipt.json][Source-bound conformance receipt]] records the
...
CI follow-through: added manual dispatch, a strict ~snapshot distribution acceptance~ aggregate,
...
native GraphAr on Ubuntu/macOS, Arrow IPC fuzz, and snapshot distribution acceptance. The complete
